...
CREATE  TABLE IF NOT EXISTS `projectfflogs`.`report` (
  ...
  `id_expansion` VARCHAR(255) NOT NULL ,
...
CREATE  TABLE IF NOT EXISTS `projectfflogs`.`staticmember` (
  ...
  PRIMARY KEY (`fk_id_static`, `fk_id_member`) ,
...
CREATE  TABLE IF NOT EXISTS `projectfflogs`.`encounter` (
  ...
  `boss_name` VARCHAR(45) ,
  `fk_id_difficulty` INT(11) NOT NULL ,
  `fk_id_timeline` INT(11) NOT NULL ,
  PRIMARY KEY (`id_encounter`) ,
  UNIQUE INDEX `id_encounter_UNIQUE` (`id_encounter` ASC) ,
